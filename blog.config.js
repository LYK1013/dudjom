...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '敦珠血传', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '旦巴仁波切', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dudjomonline.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Dudjom, 敦珠血传', // 网站关键词 英文逗号隔开
